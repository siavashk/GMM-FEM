...
MeshQueryResult is_inside(const Point3d& pnt, const PolygonMesh& mesh, double tol,
    ...
    return is_inside(pnt, mesh, *tree, data, tol, numRetries, baryEpsilon);
}
...
MeshQueryResult is_inside(const Point3d& pnt, const PolygonMesh& mesh, const BVTree& bvt,
    ...
    InsideMeshQueryData data;
    MeshQueryResult inside = is_inside_or_on(pnt, mesh, bvt, data, tol, numRetries, baryEpsilon);
...
MeshQueryResult is_inside(const Point3d& pnt, const PolygonMesh& mesh, const BVTree& bvt,
        InsideMeshQueryData& data, double tol, int numRetries, double baryEpsilon) {
    MeshQueryResult inside = is_inside_or_on(pnt, mesh, bvt, data, tol, numRetries, baryEpsilon);
